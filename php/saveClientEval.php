...
$varchars = array('firstname','lastname','title','company','tel','email','date','dateSubmitted','explained','communication','progression','duration','quality','experienced','training','undertake','recommend','canUse','msIT','ciscoIT','webApp','bizAdmin','bizMan','msTech','msEnd','ciscoTech','webTrain','msVouchers','exam','recruit','design','explainedComments','communicationComments','progressionComments','durationComments','qualityComments','experiencedComments','trainingComments');
/* $ints array is for any numeric field data types */
$ints = array();

// start building the SQL string
$str = 'INSERT INTO clientEvals (';

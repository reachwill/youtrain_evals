...
$varchars = array('firstname','company','course','email','start','end','trainer','date','tel','trainerComments','awardComments','impact','impactComments','improvements','improvementsComments','lastname','recommend','canuse','eval_interval');
/* $ints array is for any numeric field data types */
$ints = array('clarity','content','duration','format','frequency','helpfulness','induction','ongoing','relevance','award');

// start building the SQL string
$str = 'INSERT INTO apprenticeEvals (';
